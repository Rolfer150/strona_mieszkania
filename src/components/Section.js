...
const Section = () => {
    return <div className="p-40 text-center">
        ...
        <div className="flex justify-between text-white mt-10">
            {/* Pierwszy panel */}
            <div className="bg-[#0D1728] p-8 rounded-2xl flex flex-col hover:scale-105 transition duration-500">
                <div className="flex justify-center pt-4">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="w-14 h-14 p-3 rounded-full bg-[#17C2EC]">
                        <path stroke-linecap="round" stroke-linejoin="round" d="m7.875 14.25 1.214 1.942a2.25 2.25 0 0 0
                        1.908 1.058h2.006c.776 0 1.497-.4 1.908-1.058l1.214-1.942M2.41 9h4.636a2.25 2.25 0 0 1 1.872
                        1.002l.164.246a2.25 2.25 0 0 0 1.872 1.002h2.092a2.25 2.25 0 0 0 1.872-1.002l.164-.246A2.25 2.25
                        0 0 1 16.954 9h4.636M2.41 9a2.25 2.25 0 0 0-.16.832V12a2.25 2.25 0 0 0 2.25 2.25h15A2.25 2.25 0 0
                        0 21.75 12V9.832c0-.287-.055-.57-.16-.832M2.41 9a2.25 2.25 0 0 1 .382-.632l3.285-3.832a2.25 2.25
                        0 0 1 1.708-.786h8.43c.657 0 1.281.287 1.709.786l3.284 3.832c.163.19.291.404.382.632M4.5
            ...
            {/* Drugi panel */}
            <div className="bg-[#0D1728] p-8 rounded-2xl hover:scale-105 transition duration-500">
                <div className="flex justify-center pt-4">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="w-14 h-14 p-3 rounded-full bg-[#17C2EC]">
            ...
            <div className="bg-[#0D1728] p-8 rounded-2xl hover:scale-105 transition duration-500">
                <div className="flex justify-center pt-4">
                    ...
                    stroke="currentColor" class="w-14 h-14 p-3 rounded-full bg-[#17C2EC]">
                        <path stroke-linecap="round" stroke-linejoin="round"
                        d="M2.25 18.75a60.07 60.07 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75
                        ...
                        1.125h-.375m1.5-1.5H21a.75.75 0 0 0-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 0
                        1-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 0 0 3 15h-.75M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm3
